...
## Package: DesignCHnage
- **Imports**: ast, collections, os, pathlib, re
- **Imported By**: None
...
## Package: root
- **Imports**: __future__, aiosqlite, argparse, ast, asyncio, collections, core, json, logging, os, pathlib, re, requests, shutil, signal, subprocess, sys, threading, time, traceback, typing
- **Imported By**: None
- **External Dependencies**: (Evaluated via standard library exclusion heuristic)
- **Coupling Score**: 21
- **Centrality Score**: 0
