# API Analyst Report: voice\audio_utils.py
...
### `ffmpeg_microphone`
`def ffmpeg_microphone(sampling_rate: int, chunk_length_s: float, format_for_conversion: str='f32le', ffmpeg_input_device: str | None=None, ffmpeg_additional_args: list[str] | None=None)`
...
`def ffmpeg_microphone_live(sampling_rate: int, chunk_length_s: float, stream_chunk_s: int | None=None, stride_length_s: tuple[float, float] | float | None=None, format_for_conversion: str='f32le', ffmpeg_input_device: str | None=None, ffmpeg_additional_args: list[str] | None=None)`
